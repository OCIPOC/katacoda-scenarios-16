In the last scenario, we created a simple one layered neural network. The goal of the current one is to add at least one another layer. We will continue to work with _fully connected_ NNs.
