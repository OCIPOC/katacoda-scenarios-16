The output of the first convolutional layer is of a shape that can be directly fed into the second one. Your task here is to set up the next convolutional layer.
